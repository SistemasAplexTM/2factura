                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div id="fileToPrint">
                                        ...
                                        <br />
                                        <a class="btn btn-success btn-lg" onclick="javascript:jsWebClientPrint.print('useDefaultPrinter=' + $('#useDefaultPrinter').attr('checked') + '&printerName=' + encodeURIComponent($('#installedPrinterName').val()) + '&filetype=' + $('#ddlFileType').val());">P...</a>
                                    </div>
                                </div>
                            </div>
                            <h5>File Preview</h5>
