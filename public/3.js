...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__api_admin_product__ = __webpack_require__(1634);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    allByIds: function allByIds() {
      ...
      Object(__WEBPACK_IMPORTED_MODULE_2__api_admin_product__["d" /* getAdminProductMetaByIds */])({ 'id': this.id }).then(function (_ref) {
        var data = _ref.data;
