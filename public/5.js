    ...
    save: function save(push) {
      ...
      this.$refs['formParams'].validate(function (valid) {
        if (valid) {
          ...
          Object(__WEBPACK_IMPORTED_MODULE_1__api_config__["b" /* saveConfig */])('params_print_product', 'params', false, _this.params).then(function (_ref) {
            var data = _ref.data;
                ...
                [
                  ...
                  _c(
                    ...
                    [
                      _c(
                        "el-form-item",
                        { attrs: { label: "Formato", prop: "format" } },
                        [
                          _c(
                            "el-select",
                            {
                              ...
                              model: {
                                value: _vm.formParams.format,
                                callback: function($$v) {
                                  _vm.$set(_vm.formParams, "format", $$v)
                                },
                                expression: "formParams.format"
                              }
                            },
